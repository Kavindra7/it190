            ...
            <form method="get" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8 col-sm-offset-2">                                              
                        <a class="btn btn-primary" href="${pageContext.request.contextPath}/StoresReport.sales?branch=${branch_detail.getId()}" type="submit">View Stock Report</a>
                    </div>
                    <% } else { %>
                    <div class="col-sm-8 col-sm-offset-2">                       
                        <a class="btn btn-primary" href="${pageContext.request.contextPath}/SalesReport.sales?branch=${branch_detail.getId()}" type="submit">View Sales Report</a>
                        <a class="btn btn-primary" href="${pageContext.request.contextPath}/StoresReport.sales?branch=${branch_detail.getId()}" type="submit">View Stock Report</a>
                    </div>
                    <% } %>
                </div>
        ...
        <div class="hpanel">
            <div class="nav nav-tabs">
                ...
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#tab-8">System Users</a></li>
                    <li class=""><a data-toggle="tab" href="#tab-9">Vehicles</a></li>
                    <li class=""><a data-toggle="tab" href="#tab-10">Drivers</a></li>
                    
                    <li class=""><a data-toggle="tab" href="#tab-12">Received Product Requests</a></li>
                </ul>
                <% } else { %>
                <ul class="nav nav-tabs">
                    <li class="active"><a data-toggle="tab" href="#tab-8">System Users</a></li>
                    <li class=""><a data-toggle="tab" href="#tab-9">Vehicles</a></li>
                    <li class=""><a data-toggle="tab" href="#tab-10">Drivers</a></li>
                    <li class=""><a data-toggle="tab" href="#tab-11">Own Product Requests</a></li>  
                    <li class=""><a data-toggle="tab" href="#tab-12">Received Product Requests</a></li>
                </ul>
                <% } %>
                <div class="tab-content ">
                    ...
                    <table id="tblRRequest" class="table table-striped table-bordered table-hover" width="100%">
                        ...
                        <tbody>
                        <c:forEach items="${r_requests}" var="orequest" varStatus="loop">
                                    <tr>
                                        <td>${loop.index+1}</td>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-primary btn-circle RRequest"  data-rrequest='${orequest.getJson()}' type="button" id=""><i class="fa fa-list"  ></i></button>
                                            <c:if test = "${orequest.getStatus()=='Approved'}">
                                            <button class="btn btn-primary btn-circle RRequest_dispatch"  data-rrequest='${orequest.getJson()}' type="button" id=""><i class="fa fa-arrow-right"  ></i></button>
                                            </c:if>
                                            <c:if test = "${orequest.getStatus()=='Shipping'}">
                                            <button class="btn btn-primary btn-circle RRequest_deliverd"  data-rrequest='${orequest.getJson()}' type="button" id=""><i class="fa fa-arrow-down"  ></i></button>
                                            </c:if>
                                        </td>
                                    </tr>
                            </c:forEach>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-header text-center">
                                    ...
                                    <small class="font-bold">Vehicles used for Stock exchanges.!</small>
                                </div>
                                <div class="modal-body">
                                     ...
                                     <!--     -->
                                       <form role="form" id="form_createvehicle" class="form-horizontal" method="POST" action="${pageContext.request.contextPath}/TransportServlet.sales" >
                                           ...
                                           <input type="text" value="${branch_detail.getId()}" name="branch"  hidden >
                                           <div class="form-group"><label class="col-sm-2 control-label">Fuel Type<span style="color: red;">*</span></label>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form role="form" id="form_viewvehicle" class="form-horizontal">
                                           ...
                                           <div class="form-group"><label class="col-sm-2 control-label">Fuel Type</label>
