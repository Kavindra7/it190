...
<aside id="menu">
    <div id="navigation">
        <div class="profile-picture">
            <a href="index.html">
                <img src="${pageContext.request.contextPath}/images/profile.jpg" style="width: 60px;" class="img-circle m-b" alt="logo">
            </a>

            <div class="stats-label text-color">
                <span class="font-extra-bold font-uppercase">Levis Phew</span>
               ...
               <ul class="nav" id="side-menu">
                        <li>
                                 <a href="${pageContext.request.contextPath}/UserServlet"> <span class="nav-label">Users</span> </a>
                             </li>
