...
<div class="row">
                        ...
                        <div class="row " style="padding-bottom:20px;">
                            <div class="col-md-12 text-right">
                                <button class="btn btn-primary " id="CreateBranch" type="button"><i class="fa fa-plus"></i> New</button>
                            </div>
                        </div>
                        ...
                        <tbody>
                            <c:forEach items="${branches}" var="item">
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-primary btn-circle EditBranch" type="button" data-branch='${item.getJson()}'><i class="fa fa-edit"></i></button>
                                            <button class="btn btn-danger btn-circle DeleteBranch" type="button" id="" data-branch='${item.getJson()}'><i class="fa fa-times"  ></i></button>
                                            <button class="btn btn-primary btn-circle ViewBranch" type="button" id="" data-branch='${item.getJson()}'><i class="fa fa-list"  ></i></button>
                                            <a class="btn btn-primary btn-circle InfoBranch" type="button" id="" data-branch='${item.getJson()}' href="${pageContext.request.contextPath}/BranchServlet.sales?branch=${item.getId()}" ><i class="fa fa-info"  ></i></a>
                                            <a class="btn btn-primary btn-circle" type="button" id=""  href="${pageContext.request.contextPath}/SalesReport.sales?branch=${item.getId()}" ><i class="fa fa-dollar"  ></i></a>
                                            <a class="btn btn-primary btn-circle" type="button" id=""  href="${pageContext.request.contextPath}/StoresReport.sales?branch=${item.getId()}" ><i class="fa fa-download"  ></i></a>
                                        </td>
                                    </tr>
                            </c:forEach>
